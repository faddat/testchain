...
import (
	...
	appparams "github.com/faddat/testchain/app/params"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/.testchain")
	}
...
func New(
	...
	app.testchainKeeper = *testchainkeeper.NewKeeper(
        appCodec, keys[testchaintypes.StoreKey], keys[testchaintypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		testchain.NewAppModule(appCodec, app.testchainKeeper),
